        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Grocery and food items", "Food" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "Description", "LowStockThreshold", "Name", "Price", "StockQuantity" },
                values: new object[,]
                {
                    { 1, 1, "", 5, "Laptop", 999.99m, 15 },
                    { 2, 2, "", 20, "T-Shirt", 19.99m, 100 },
                    { 3, 3, "", 10, "Coffee", 8.99m, 50 }
                });
